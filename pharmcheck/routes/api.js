		...
		const reports = [
			{
				...
				actions:[{ caption: "Создать", url: "" }, { caption: "Править", url: "" }, { caption: "Удалить", url: "" }],
				fields: [
					...
					{ id: 11, name: 'Цена', type: 'number', key: 'Price', conditions: [{ field: 'Qty', condition: 'lt', color:'green'}]  },
					{ id: 12, name: 'Величина скидки', type: 'number', key: 'Discount', conditions: [{ field: 'Qty', condition: 'lt', color: 'red' }]   },
